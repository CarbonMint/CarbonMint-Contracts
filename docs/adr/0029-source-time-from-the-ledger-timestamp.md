...
The CarbonMint smart contract needs a clear, documented approach to "source time from the ledger timestamp" so the codebase stays consistent and auditable.
