...
The CarbonMint smart contract needs a clear, documented approach to "model storage keys with a datakey enum" so the codebase stays consistent and auditable.
