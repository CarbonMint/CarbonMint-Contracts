...
The CarbonMint smart contract needs a clear, documented approach to "consider reentrancy on external calls" so the codebase stays consistent and auditable.
