...
The CarbonMint smart contract needs a clear, documented approach to "separate instance and persistent storage" so the codebase stays consistent and auditable.
